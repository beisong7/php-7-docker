                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="m-t-25">
                                    <form method="post" action="{{ route('automate.update', $auto->uuid) }}" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label for="title">Automate Title</label>
                                                    <input type="text" name="title" class="form-control" id="title" placeholder="Title" autocomplete="off" required value="{{ $auto->title }}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="info" class="form-control" id="info" autocomplete="off" required>{!! $auto->info !!}</textarea>
                                                </div>
                                            </div>
                                        </div>
