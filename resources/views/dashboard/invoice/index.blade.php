                    ...
                    <div id="invoice" class="p-h-30">
                        <div class="m-t-15 lh-2">
                            <div class="inline-block">
                                <img class="img-fluid" src="{{ url('assets/images/logo/logo.png') }}" alt="">
                        ...
                        <div class="m-t-20">
                            ...
                            <div class="row m-v-20">
                                <div class="col-sm-6">
                                    <img class="img-fluid text-opacity m-t-5" width="100" src="{{ url('assets/images/logo/logo.png') }}" alt="">
                                </div>
