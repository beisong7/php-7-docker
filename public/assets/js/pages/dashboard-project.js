...
//eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _constant_theme_constant__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../constant/theme-constant */ \"./app/assets/es6/constant/theme-constant.js\");\n\r\n\r\nclass DashboardProject {\r\n\r\n    static init() {\r\n        \r\n        $('.datepicker-calendar').datepicker();\r\n        \r\n        const completionChart = document.getElementById(\"completion-chart\");\r\n        let gradient = completionChart.getContext('2d').createLinearGradient(0, 30, 10, 320);\r\n        gradient.addColorStop(0, _constant_theme_constant__WEBPACK_IMPORTED_MODULE_0__[\"default\"].blueLight);\r\n        gradient.addColorStop(1, _constant_theme_constant__WEBPACK_IMPORTED_MODULE_0__[\"default\"].transparent);\r\n        const lineCtx = completionChart.getContext('2d');\r\n        completionChart.height = 120;\r\n        const lineConfig = new Chart(lineCtx, {\r\n            type: 'line',\r\n            data: {\r\n            labels: [\"16th\", \"17th\", \"18th\", \"19th\", \"20th\", \"21th\", \"22th\", \"23th\", \"24th\", \"25th\", \"26th\"],\r\n            datasets: [{\r\n                    label: 'Series A',\r\n                    data: [30, 60, 40, 50, 40, 55, 85, 65, 75, 50, 70],\r\n                    backgroundColor: gradient,\r\n                    borderColor: _constant_theme_constant__WEBPACK_IMPORTED_MODULE_0__[\"default\"].blue,\r\n                    pointBackgroundColor: _constant_theme_constant__WEBPACK_IMPORTED_MODULE_0__[\"default\"].blue,\r\n                    pointBorderColor: _constant_theme_constant__WEBPACK_IMPORTED_MODULE_0__[\"default\"].white,\r\n                    pointHoverBackgroundColor: _constant_theme_constant__WEBPACK_IMPORTED_MODULE_0__[\"default\"].blueLight,\r\n                    pointHoverBorderColor: _constant_theme_constant__WEBPACK_IMPORTED_MODULE_0__[\"default\"].blueLight\r\n                }]\r\n            },\r\n            options: {\r\n                legend: {\r\n\t\t\t\t\tdisplay: false\r\n\t\t\t\t},\r\n                maintainAspectRatio: false,\r\n                responsive: true,\r\n                hover: {\r\n                    mode: 'nearest',\r\n                    intersect: true\r\n                },\r\n                tooltips: {\r\n                    mode: 'index'\r\n                },\r\n                elements: {\r\n                    line: {\r\n                        tension: 0,\r\n                        borderWidth: 2\r\n                    }\r\n                },\r\n                scales: {\r\n                    xAxes: [{ \r\n                        gridLines: [{\r\n                            display: false,\r\n                        }],\r\n                        ticks: {\r\n                            display: true,\r\n                            fontColor: _constant_theme_constant__WEBPACK_IMPORTED_MODULE_0__[\"default\"].grayLight,\r\n                            fontSize: 13,\r\n                            padding: 10\r\n                        }\r\n                    }],\r\n                    yAxes: [{\r\n                        gridLines: {\r\n                            drawBorder: false,\r\n                            drawTicks: false,\r\n                            borderDash: [3, 4],\r\n                            zeroLineWidth: 1,\r\n                            zeroLineBorderDash: [3, 4]  \r\n                        },\r\n                        ticks: {\r\n                            display: true,\r\n                            max: 100,                            \r\n                            stepSize: 20,\r\n                            fontColor: _constant_theme_constant__WEBPACK_IMPORTED_MODULE_0__[\"default\"].grayLight,\r\n                            fontSize: 13,\r\n                            padding: 10\r\n                        }  \r\n                    }],\r\n                }\r\n            }\r\n        });\r\n    }\r\n}\r\n\r\n$(() => { DashboardProject.init(); });\r\n\r\n\n\n//# sourceURL=webpack:///./app/assets/es6/pages/dashboard-project.js?");
        ...
        var jqxhr = $.get( "/get-chart-data", function(data) {
            console.log(data);
            server.days = data.days;
            server.count = data.count;

            let highest = 0;
            server.count.forEach(function (val) {
                val = parseInt(val);
                highest = val > highest ? val : highest;
                console.log(val, highest);
            });
            let dynamic_step = Math.round(highest / 10);
            console.log(`dynamic steps = ${dynamic_step}`);
            "use strict";
            __webpack_require__.r(__webpack_exports__);
            /* harmony import */
            var _constant_theme_constant__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../constant/theme-constant */ "./app/assets/es6/constant/theme-constant.js");
            class DashboardProject {
                static init() {
                    $('.datepicker-calendar').datepicker();
                    const completionChart = document.getElementById("completion-chart");
